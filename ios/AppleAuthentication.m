...
- (void)authorizationController:(ASAuthorizationController *)controller
  ...
  NSString *suffixName;
  NSString *nickName;
  NSString *phoneticRepresentation;
    
  if (credential.fullName) {
    givenName = RCTNullIfNil(credential.fullName.givenName);
    middleName = RCTNullIfNil(credential.fullName.middleName);
    familyName = RCTNullIfNil(credential.fullName.familyName);
    prefixName = RCTNullIfNil(credential.fullName.namePrefix);
    suffixName = RCTNullIfNil(credential.fullName.nameSuffix);
    nickName = RCTNullIfNil(credential.fullName.nickname);
    phoneticRepresentation = RCTNullIfNil(credential.fullName.phoneticRepresentation);
  }
